...
#ifndef FLUID_NEW_MATH_HPP
#define FLUID_NEW_MATH_HPP
...
public:
    ...
    double increase_density(std::array <double, 3> pi, std::array <double, 3> pj);
    double transform_density(double Ri);
    std::array<double, 3> increase_accerelation(Particle pi, Particle pj);
